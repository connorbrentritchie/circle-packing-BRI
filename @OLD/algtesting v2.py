...
def maxClusterAlg(radii, doPause: bool, doStats: bool):
...
def randomClusterAlg(radii):
    ...
    for index, rk in enumerate(radii):
        ...
        minp = sortedPossibles[random.randint(0, len(sortedPossibles)-1)] #chooses the placement with the smallest pcdSum
...
maxCluster = maxClusterAlg(radii,False,False)
randCluster = randomClusterAlg(radii)
#drawC(randCluster)
#drawC(maxCluster)
